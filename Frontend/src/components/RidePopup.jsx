    ...
    <div>
      ...
      <div className='flex gap-2 justify-between flex-col items-center'>
        ...
        <div className='mt-5 flex items-center justify-between w-full'>
            <button onClick={() => props.setRidePopupPanel(false)} className=' mt-1 bg-gray-300 text-gray-700 font-semibold p-3 px-10 rounded-xl'>Ignore</button>
            <button onClick={() => props.setConfirmRidePopupPanel(true)} className='bg-green-600 text-white font-semibold p-3 px-10 rounded-xl'>Accept</button>
        </div>
      </div>
    </div>
  )
