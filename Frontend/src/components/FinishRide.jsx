...
const FinishRide = (props) => {
  return (
    <div>
      <h5 className='p-1 text-center w-[90%] absolute top-0' onClick={() => props.setFinishRidePanel(false)}><i className='text-3xl text-gray-200 ri-arrow-down-wide-line'></i></h5>
      ...
      <div className='flex gap-2 justify-between flex-col items-center'>
        ...
        <div className='mt-10 w-full'>
            ...
            {/* <p className='mt-10 text-xs'>click on finish ride button if you completed the payment.</p> */}
        </div>
      </div>
    </div>
  )
